<template>
	<main class="converter">
        ...
        <section class="converter__euro">
            <p class="euro__text">eur</p>
                
            <input type="text" class="euro__valuta" v-model="eurValuta">

            <button @click="calculate" aria-label="Click here to convert the valuta">
        ...
        <section class="converter__country-code">
        ...
        <section class="converter__logo" aria-label="Logo">
